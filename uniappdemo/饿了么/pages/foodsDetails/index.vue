 ...
 * @LastEditTime: 2021-03-18 06:01:15
...
export default {
  ...
  data () {
    return {
      ...
      // ],
      ratings: [
        { avatar: '/static/img/kobe.png', username: 'yuandabo', score: 0, text: '非常不好', rateTime: '20200829' },
        { avatar: '/static/img/kobe.png', username: 'yuandabo', score: 5, text: '非常好', rateTime: '20200829' },
        { avatar: '/static/img/kobe.png', username: 'yuandabo', score: 3, text: '一般般', rateTime: '20200829' },
        { avatar: '/static/img/kobe.png', username: 'yuandabo', score: 3, text: '', rateTime: '20200829' },
        { avatar: '/static/img/kobe.png', username: 'yuandabo', score: 0, text: '非常不好', rateTime: '20200829' },
        { avatar: '/static/img/kobe.png', username: 'yuandabo', score: 5, text: '非常好', rateTime: '20200829' },
        { avatar: '/static/img/kobe.png', username: 'yuandabo', score: 3, text: '一般般', rateTime: '20200829' }
      ]
  ...
  computed: {
    ...
    details () {
      ...
      const { id } = JSON.parse(this.$route.query.details)
